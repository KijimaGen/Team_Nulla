...
public class CharacterData_importer : AssetPostprocessor {
	private static readonly string filePath = "Assets/WorkSpace/Shiokawa_Yutaro/Resources/MasterData/CharacterData.xlsx";
	private static readonly string exportPath = "Assets/WorkSpace/Shiokawa_Yutaro/Resources/MasterData/CharacterData.asset";
		...
		foreach (string asset in importedAssets) {
			...
			using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite)) {
				...
				foreach(string sheetName in sheetNames) {
					...
					cell = row.GetCell(2); p.nameList = (int)(cell == null ? 0 : cell.NumericCellValue);
